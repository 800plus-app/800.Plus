 ...
 *
 * ⚠ חמשת הצעדים אינם עצות כלליות. כל אחד מתאר משהו שהמוצר באמת עושה,
 * או עובדה שכבר אושרה: "4 מתוך 6 פרקי הפסיכומטרי" הוא הניסוח שחגי אישר
 * ב-3.8 אחרי שפסל את "הפרקים המנוקדים" (`/HEB` §1א). אין כאן שום מספר
...
const STEPS: Step[] = [
  ...
  {
    n: "05",
    title: ["עברית ואנגלית ביחד"],
    why: "4 מתוך 6 פרקי הפסיכומטרי נשענים על אוצר מילים",
  },
];
