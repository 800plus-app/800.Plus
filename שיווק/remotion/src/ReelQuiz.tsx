...
const WORDS: Q[] = [
  { w: "בְּרַם", d: "אולם · אבל · עם זאת", unit: "10" },
  { w: "superfluous", d: "מיותר, עודף", unit: "10", ltr: true },
  { w: "אָשְׁיוֹת", d: "מסד · בסיס · יסוד", unit: "10" },
  { w: "obstinate", d: "עקשן", unit: "10", ltr: true },
  { w: "גַּחֲמָה", d: "רצון פתאומי בלי טעם הגיוני · קפריזה", unit: "10" },
];
