...
const steps = [
  ...
  /* ⚠ המפריד בבאנר של הרנר סובלני בכוונה. הוא היה `PASS —`, וסבב הסרת המקף הארוך
     ב-`main` הפך אותו ל-`PASS --` · השער כאן המשיך לחפש את הישן ודיווח ⛔ על ריצה
     שהייתה 0 כשלים. שער שנופל על תו פיסוק אינו שער. */
