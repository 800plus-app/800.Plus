...
*/
/* הוכחת שיניים ל-tests/83-wtp-impression.
...
['tests/83-wtp-impression.test.js', 'tests/_harness/sandbox.js', 'tests/_harness/extract.js',
...
const r = cp.spawnSync(process.execPath, ['--test', 'tests/83-wtp-impression.test.js'],
