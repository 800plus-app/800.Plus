...
*/
/* הוכחת שיניים ל-tests/84-contrast-tokens.
 *
...
['tests/84-contrast-tokens.test.js', 'index.html']
...
const r = cp.spawnSync(process.execPath, ['--test', 'tests/84-contrast-tokens.test.js'],
