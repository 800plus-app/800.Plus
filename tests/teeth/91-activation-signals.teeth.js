...
*/
/* הוכחת שיניים ל-tests/91-activation-signals.
...
['tests/91-activation-signals.test.js', 'tests/_harness/sandbox.js', 'tests/_harness/extract.js',
...
const r = cp.spawnSync(process.execPath, ['--test', 'tests/91-activation-signals.test.js'],
