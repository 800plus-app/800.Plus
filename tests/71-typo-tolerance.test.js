...
describe('סובלנות איות · מתג הכיבוי והתלות בלקסיקון', () => {
  ...
  test('שכבת הלקסיקון נושאת במשקל · בלעדיה נפתחות בדיוק הקבלות שנמדדו', t => {
    ...
    /* המספרים נמדדו על אותה טבלת זהב. הם מוצמדים ולא מושווים ל"גדול מאפס":
       ...
       הכיוון הזה הוא **הנכון**: הסובלנות התרחבה, ולכן יש יותר מחרוזות שרק
       הלקסיקון עוצר. ירידה כאן הייתה הסימן המדאיג · היא הייתה אומרת שהשכבה
       נחלשה בשקט. */
    assert.deepStrictEqual(opened, { 'he-word': 10, 'en-word': 21, gloss: 5 },
