...
# מילות תפקוד — חלק מניבים, ולכן אינן נספרות כמעגליות
FUNC = set('''ממנו ממנה מהם אליו אליה עליו עליה עליהם בהם בהן בכל מכל לכל
אותו אותה אותם עצמו עצמה כמו אחרי לפני תחת בין מתוך בתוך אצל כדי בלי ללא
את של על אל מן כל לא אין יש מה מי זה זו הוא היא הם הן שלו שלה כאשר אשר
לו לה להם לנו כפי לפי דבר יותר פחות מאוד'''.split())
...
def check(rows):
    ...
    for u, i, disp, word, root, g in rows:
        ...
        # מילות תפקוד בתוך ניב אינן "המילה הנלמדת" — "נבצר ממנו" מול "נמנע ממנו"
