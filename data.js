...
window.UNIT_DATA = {
 "1": [
  ...
  [
   "נִגַף",
   "הובס, נוצח; מחלה קשה המפילה חללים רבים; תקלה, מכשול (אֶבֶן נֶגֶף - מכשול)"
  ],
  [
   "נָדָן",
   "נרתיק החרב"
 ...
 "4": [
  ...
  [
   "חַרְטוֹם",
   "החלק הקדמי של חפץ כלשהו, כלי שייט/טייס, בעל-חיים"
  ],
  [
   "חָשׁ",
  ...
  [
   "מְפַעְפֵּעַ",
   "מחלחל, חודר; מעלה בועות משמיע רשע של מים רותחים, מבעבע"
  ],
  [
   "מַצְבִּיא",
   "מפקד צבאי בכיר, קצין"
  ...
  [
   "תָּמַהּ",
   "הטיל ספק, התחבט לגבי נכונותו של הדבר; התפלא, מוזר ומפתיע"
  ],
  [
   "תַּסְכִּית",
 ...
 "7": [
  ...
  [
   "מֵלִיץ",
   "מי שממליץ על מישהו ומבר בזכותו; מתורגמן"
  ],
  [
   "מַנְפֵּטָה",
  ...
  [
   "נֵצֶר",
   "בן, צאצא; ענף רך הצומח מהשורש; שמר, הגן"
  ],
  [
   "נָשִׂיא",
   "ענן נושא גשם"
  ...
  [
   "שִׁוֵּעַ",
   "התחנן, זעק; היה זקוק למשהו נואשות; בעל הון, עשיר"
  ],
  [
   "שָׁזַף",
   "ראה, הביט; שרף, צרב"
