...
window.UNIT_DATA = {
 ...
 ,
  ...
  [
   "אָרַג",
   "יצר בד מחוטי שתי וערב; רקם תוכנית בסתר"
  ],
  [
   "עִרְטֵל",
   "הפשיט, חשף מכל כיסוי"
  ...
  [
   "מְעִילָה",
   "שימוש לרעה בכסף או ברכוש שהופקד בידיו; בגידה באמון"
  ],
  [
   "מִקְטוֹרֶן",
 ...
 "5": [
  ...
  [
   "יוֹבֵל",
   "תקופת חמישים שנה; קרן איל המשמשת ככלי נשיפה"
  ],
  [
   "יוֹגֵב",
 ...
 "9": [
  ...
  [
   "התקין",
   "הִתְקִין — הכין, סידר, יצר; חיבר והרכיב דבר במקומו; קבע תקנה, חוקק"
  ],
  [
   "וַרְיַאצְיָה",
   "נוסח, גירסה"
