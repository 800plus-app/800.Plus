...
window.UNIT_DATA = {
 ...
 "3": [
  ...
  [
   "צִיר",
   "מיץ, רוטב; שליח, מיופה כוח, מעין שגריר"
  ],
  [
   "צְנִים",
   "טוסט, קלי"
 ...
 "4": [
  ...
  [
   "סִפּוּן",
   "תקרה, חלקה העליון של האוניה (התקרה של בטן האוניה); צפון, נסתר"
  ],
  [
   "עוּל יָמִים",
   "צעיר"
  ...
  [
   "שְׂדֵרָה",
   "שכבה חברתית, מעמד, סטטוס; שיירה (בד\"כ של כלי רכב), שורה; רחוב רחב, סימטה"
  ],
  [
   "שִׁנֵּן",
 ...
 "5": [
  ...
  [
   "אָמָה",
   "משרתת, שפחה; מידת אורך קדומה (מהמרפק עד שורש כף היד)"
  ],
  [
   "אֶמְפִּירִי",
  ...
  [
   "עָרַג",
   "זעק, התחנן; רצה מאוד, השתוקק, התגעגע"
  ],
  [
   "עֲרִירִי",
 ...
 "6": [
  ...
  [
   "עִקֵּר",
   "גרם לו להיות עקר (חסר יכולת להביא צאצאים); חיטא, טיהר; תלש, שלף, קרע אותו ממקומו; היגר, ירד (מהארץ); חסר טעם או תועלת; שאינו פורה, לא מסוגל להוליד צאצאים"
  ],
  [
   "עָקַר אֶת רַגְלָיו",
   "הלך"
 ...
 "7": [
  ...
  [
   "מַאְפֵּלְיָה",
   "מקום משכנו של הרשע; חושך מוחלט, אפלה"
  ],
  [
   "מִבְדוֹק",
  ...
  [
   "תִּעֵל",
   "הפנה לאפיק מסוים, כִּיוֵן; חפר תעלות לניקוז או השקיה; רפואה"
  ],
  [
   "תַּשׁ",
   "הפך לחלש, התעייף"
 ...
 "8": [
  ...
  [
   "אֹרַח",
   "אופן התנהגות, דרך חיים, הליכות; מנהג; (גם: אורח)"
  ],
  [
   "אַרְכֻּבָּה",
  ...
  [
   "כֹּפֶר",
   "תשלום שנדרשים לשלם על מנת להציל חיי אדם; לא הסכים עם דבר מקובל; התכחש לקיום האל; לא הודה בהאשמות המיוחסות לו"
  ],
  [
  ...
  [
   "מְדוּכָה",
   "גליל המשמש לשיגור מטעני נפץ; קערה המשמשת לכתישה בעזרת עלי (מוט בצורת גליל)"
  ],
  [
   "מְהַדְּרִין",
