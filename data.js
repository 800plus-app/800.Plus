...
window.UNIT_DATA = {
 ...
 "3": [
  ...
  [
   "בָּזַק",
   "לפצל לשני ערכים — בָּזַק: פיזר, הפיץ, זרה · בָּזָק: מהירות רבה, הרף עין (מבצע בזק)"
  ],
  [
   "בְּחַדְרֵי חֲדָרִים",
   "בצורה לא גלויה, בסתר"
  ...
  [
   "בַּר",
   "לפצל לפי ניקוד — בָּר: תבואה מנופה · בַּר: זך, נקי (בר לבב) · בַּר: שדה או שטח לא מיושב, פראי ולא מעובד (חתול בר) · בַּר: בעל תכונה או מעמד, ראוי ל־ (בר קיימא, בר השגה) · בַּר: בנו של (ארמית)"
  ],
  [
   "בַּר-שְׁפִיטָה",
   "מי שניתן לשפוט אותו"
 ...
 "7": [
  ...
  [
   "תִּכְתּוֹבֶת",
   "חילופי הודעות כתובות בין אנשים, ארגונים או מוסדות, וכן אוסף ההודעות עצמן"
  ],
  [
   "תִּלֵי תִּילִים",
   "שפע רב"
