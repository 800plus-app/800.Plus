...
window.UNIT_DATA = {
 ...
 "2": [
  ...
  [
   "מָחָה",
   "התנגד, הביע מחאה; השמיד, השכיח, מחק; ניגב (מחה דמעה)"
  ],
  [
   "מֶחֱוָה",
 ...
 "3": [
  ...
  [
   "כִּיכָּר",
   "רחבה ציבורית או מעגל תנועה; לחם עגול שלם; יחידת משקל עתיקה; מישור נרחב (כיכר הירדן)"
  ],
  [
   "כָּלִיל",
  ...
  [
   "קֶלַח",
   "החלק המעובה של ירק מאכל, ובכללו האשכול שעליו גדלים גרגרי התירס (קלח תירס, קלח כרוב)"
  ],
  [
   "קְלִישָאַה / קְלִישָה",
