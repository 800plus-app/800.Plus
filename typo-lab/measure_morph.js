 ...
 * (`דוחות/מדידת-כלל-מורפולוגי.md`): גזירה לשלד עיצורי על כל מילות התוכן קיפלה 61.7%
...
function md(out) {
  ...
  p('## ⛔ ההקשר · מה כבר נדחה');
  p('');
  p('`דוחות/מדידת-כלל-מורפולוגי.md` מדד כלל מורפולוגי **כללי** (גזירה לשלד עיצורי על כל');
