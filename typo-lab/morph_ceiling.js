...
function writeReport(R) {
  ...
  p('');
  p('`דוחות/סיכומים/מדידת-כלל-מורפולוגי.md` (5.8) ו-`typo-lab/STATE.md` רושמים ש**שניים** מתוך 24');
  ...
  p('');
  p('`דוחות/סיכומים/מדידת-כלל-מורפולוגי.md` §א רושם שמקרה 18 (מִצְנֶפֶת · "כובע") מייצר **2 קבלות');
