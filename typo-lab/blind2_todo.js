 ...
 *
 * ⚠ ומה שהכלי הזה **אינו** יודע, ומה שגרם לי לשגר פעמיים את אותה אצווה:
 * הוא מראה מה **על הדיסק**, לא מה **באוויר**. סוכן שרץ עדיין נראה כאן כחסר.
 * לפני שיגור — לבדוק גם מה כבר שוגר ולא חזר. קרה פעמיים (D3-04-J2, D3-07-J2),
 * ובשני המקרים ההרצה השנייה דרסה את הראשונה. אין נזק לתוקף (השופט השני היה
 * עיוור גם לקובץ הקיים), והגרסה הדרוסה נשמרת ב-_interrater ומשמשת מדידת
 * מהימנות — אבל זה מזל, לא תכנון.
 *
