...
function main() {
  ...
  if (SELFTEST) {
    ...
    if (card) {
      t(c.meaningMatch('מחשבות שווא על עליונות', card.meaning), 'בקרה חיובית · הפירוש המקורי מתקבל');
      t(!c.meaningMatch('מחשבות שוא על עליונות', card.meaning), 'והווריאציה נדחית · זה מה שנמדד');
    }
