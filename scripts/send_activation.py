...
# היקף המאגר — מספר שיווקי יציב, זהה לזה שבסטורי ובעמוד הנחיתה. אם המאגר גדל משמעותית
# יש לעדכן כאן וב-שיווק. (render.ps1 מחשב את המקביל שלו מ-data.js לפני כל רינדור סרטון.)
WORDS = 5662
FREE_UNTIL = '30.08'
SUBJECT = 'נרשמת ל-800+ · פתוח וחינם עד ה-%s' % FREE_UNTIL
...
<table role="presentation" cellpadding="0" cellspacing="0" border="0" align="center"
  ...
  <tr><td style="padding:22px 30px 0;text-align:right">
    ...
    <p style="margin:4px 0 0;font-size:15px;line-height:1.7;color:#2c2823">פתחת חשבון ל-800+ ועוד לא התחלת לתרגל.</p>
  </td></tr>

  <!-- ההיקף הוא הסיבה שהמייל מוצדק לקהל שאין לו עדיין מספר אישי. לכן הוא הדבר הראשון
       שנראה, ולא שורה בתוך פסקה. -->
    ...
    <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%"
      ...
      <tr><td style="padding:20px;text-align:center">
        <div style="font-family:Georgia,'Times New Roman',serif;font-size:40px;line-height:1;
             font-weight:700;color:#a63c26">{WORDS:,}</div>
        <div style="margin-top:7px;font-size:13px;letter-spacing:1px;color:#8d8274">מילים · בעברית ובאנגלית</div>
      </td></tr>
    </table>
  </td></tr>

  <!-- התאריך הוא הלחץ האמיתי: חלון חינמי שנסגר, לא מילת דחיפות. -->
  <tr><td style="padding:16px 30px 0;text-align:center">
    <p style="margin:0;font-size:15px;font-weight:700;color:#a63c26">כל אוצר המילים פתוח וחינם, עד ה-{FREE_UNTIL}.</p>
  </td></tr>
