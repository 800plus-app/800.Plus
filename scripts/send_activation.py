...
WORDS = 5663   # אומת 26.8.2026: 1,717 עברית + 3,946 אנגלית, נספר מ-data.js ומ-data-en.js
...
<table role="presentation" cellpadding="0" cellspacing="0" border="0" align="center"
  ...
  <tr><td style="padding:22px 30px 0;text-align:right">
    ...
    <p style="margin:4px 0 0;font-size:15px;line-height:1.7;color:#2c2823">סבב התרגול הראשון מכסה 20 מילים.</p>
  </td></tr>
  ...
  <!-- ⛔ כאן ישבה השורה "כל אוצר המילים פתוח וחינם, עד ה-30.08". הוסרה ב-26.8.2026
       ...
       ההיקף למעלה הוא מה שמצדיק את המייל, והוא נכון תמיד. -->
